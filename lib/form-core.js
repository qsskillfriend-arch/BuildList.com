...
export const FORMS = {
  ...
  'advertising-enquiry':{ label: 'Advertising enquiry / booking', urgent: true },
  'tender-submission':  { label: 'Tender notice submission', urgent: true },
  'removal-request':    { label: 'Listing removal request', urgent: true },
